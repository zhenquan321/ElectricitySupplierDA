...
namespace IWSData.Model
{
    ...
    public class IW2S_SG_KeywordGroup
    {
    ...
    public class IW2S_SG_KeywordCategory
    {
        public ObjectId _id { get; set; }
        ...
        public int InfriLawCode { get; set; }
    ...
    public class IW2S_SG_KeywordGroupDto
    {
    ...
    public class IW2S_SG_KeywordCategoryDto
    {
        public string _id { get; set; }
    ...
    public class SG_KeywordGroupModelDto
    {
        public List<IW2S_SG_BaiduCommendDto> Selected { get; set; }
        public List<IW2S_SG_BaiduCommendDto> UnSelected { get; set; }
    }
