...
{
    public class IW2S_WB_KeywordGroup
    {
    ...
    public class IW2S_WB_KeywordCategory
    {
        public ObjectId _id { get; set; }
    ...
    public class IW2S_WB_KeywordGroupDto
    {
    ...
    public class IW2S_WB_KeywordCategoryDto
    {
        public string _id { get; set; }
    ...
    public class WB_KeywordGroupModelDto
    {
        public List<IW2S_WB_BaiduCommendDto> Selected { get; set; }
        public List<IW2S_WB_BaiduCommendDto> UnSelected { get; set; }
    }
}
