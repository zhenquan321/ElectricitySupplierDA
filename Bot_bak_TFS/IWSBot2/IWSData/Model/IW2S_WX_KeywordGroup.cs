...
{
    public class IW2S_WX_KeywordGroup
    {
    ...
    public class IW2S_WX_KeywordCategory
    {
        public ObjectId _id { get; set; }
    ...
    public class IW2S_WX_KeywordGroupDto
    {
    ...
    public class IW2S_WX_KeywordCategoryDto
    {
        public string _id { get; set; }
    ...
    public class WX_KeywordGroupModelDto
    {
        public List<IW2S_WX_BaiduCommendDto> Selected { get; set; }
        public List<IW2S_WX_BaiduCommendDto> UnSelected { get; set; }
    }
}
