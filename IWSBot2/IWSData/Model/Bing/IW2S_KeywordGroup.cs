...
{
    public class IW2S_Bing_KeywordGroup
    {
    ...
    public class IW2S_Bing_KeywordCategory
    {
        public ObjectId _id { get; set; }
    ...
    public class IW2S_Bing_KeywordGroupDto
    {
    ...
    public class IW2S_Bing_KeywordCategoryDto
    {
        public string _id { get; set; }
    ...
    public class Bing_KeywordGroupModelDto
    {
        public List<IW2S_Bing_BaiduCommendDto> Selected { get; set; }
        public List<IW2S_Bing_BaiduCommendDto> UnSelected { get; set; }
    }
}
