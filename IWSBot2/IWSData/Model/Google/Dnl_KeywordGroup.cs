...
{
    public class Dnl_Google_KeywordGroup
    {
    ...
    public class Dnl_Google_KeywordCategory
    {
        public ObjectId _id { get; set; }
    ...
    public class Dnl_Google_KeywordGroupDto
    {
    ...
    public class Dnl_Google_KeywordCategoryDto
    {
        public string _id { get; set; }
    ...
    public class Dnl_KeywordGroupModelDto
    {
        public List<Dnl_Google_BaiduCommendDto> Selected { get; set; }
        public List<Dnl_Google_BaiduCommendDto> UnSelected { get; set; }
    }
}
