...
namespace IWSData.Model
{
    public class IW2SUserDto
    {
        ...
        public long SG_KeywordCount { get; set; }
        public long BD_KeywordCount { get; set; }
        public long WB_KeywordCount { get; set; }
        public long WX_KeywordCount { get; set; }
        public long BDImg_KeywordCount { get; set; }
    }
