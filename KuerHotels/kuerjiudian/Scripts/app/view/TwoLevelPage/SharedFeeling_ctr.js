var SharedFeeling_ctr = myApp.controller("SharedFeeling_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $interval, $filter, $timeout) {
        ...
        $scope.fabu_fun = function () {
            ...
            q.success(function (response, status) {
                ...
                if (response.IsSuccess == true) {
                    ...
                    $scope.GetShare();
                    $scope.GetMyShare();
                } else { publicFunc.showAlert("温馨提示", '哎呀，网络打盹了，请重试一下！', "我知道了");
