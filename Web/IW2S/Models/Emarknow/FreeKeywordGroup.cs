...
namespace IW2S.Models.Emarknow
{
    

    public class FreeKeywordGroup
    {
    ...
    public class FreeKeywordCategory
    {
        public ObjectId _id { get; set; }
    ...
    public class FreeKeywordGroupDto
    {
    ...
    public class FreeKeywordCategoryDto
    {
        public string _id { get; set; }
    ...
    public class Free_KeywordGroupModelDto
    {
        public List<FreeTaskDto> Selected { get; set; }
        public List<FreeTaskDto> UnSelected { get; set; }
    }
