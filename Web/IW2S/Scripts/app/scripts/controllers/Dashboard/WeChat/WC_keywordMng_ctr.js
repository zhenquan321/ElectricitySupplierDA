/// <reference path="../../../modal/WC_addElementGroup_ctr.js" />
var WC_keywordMng_ctr = myApp.controller("WC_keywordMng_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, $filter, $timeout, myApplocalStorage) {
  ...
  $scope.kindGroup = function (groupId, InfriLawCode, InfriLawCodeStr, Weight, ParentName, ParentId) {
    ...
    var url = "/api/Media/GetKeywordGroup?usr_id=" + $rootScope.userID + "&groupType=" + $scope.groupType + "&projectId=" + $rootScope.getProjectId;
  ...
  $scope.EditKindGroup = function (groupId, parentid, Name, InfriLawCode, Weight, ParentName, ParentId) {
    ...
    var url = "/api/Media/GetEditKeywordGroup?usr_id=" + $rootScope.userID + "&groupType=" + $scope.groupType + "&projectId=" + $rootScope.getProjectId;
    if ($scope.keywordId != null) {
      url += "&keywordId=" + $scope.keywordId;
    }
    else {
  ...
  $scope.searchCategoryAgain = function (id) {
    $scope.isgroup = true;
    var url = "/api/Media/SetCommendKeywordsStatus?categoryId=" + id + "&prjId=" + $rootScope.getProjectId + "&isgroup=" + $scope.isgroup + "&status=" + 0 + "&user_id=" + $rootScope.userID;
    var q = $http.get(url);
    q.success(function (response, status) {
  ...
  $scope.modal_demo = function () {
    ...
    var frm = $modal.open({
      templateUrl: 'Scripts/app/views/modal/WC_addElementGroup.html',
      controller: WC_addElementGroup_ctr,
      scope: kw_scope,
      // label: label,
      keyboard: false,
      backdrop: 'static',
  ...
  $rootScope.GetBaiduSearchKeyword2 = function () {
    var url = "/api/Media/GetKeywordCategory?user_id=" + $rootScope.userID + "&groupType=" + $scope.groupType + "&projectId=" + $rootScope.getProjectId;
    if ($scope.keywordId != null) {
      url += "&keywordId=" + $scope.keywordId;
    }
    else {
  ...
  $scope.updateCategoryName = function (groupId) {
    ...
    var url = "/api/Media/UpdateKeywordGroupName?groupid=" + groupId + "&groupName=" + encodeURIComponent(name) + "&user_id=" + $rootScope.userID;
  ...
  $scope.DelCategory = function (categoryId) {
    if (confirm("确定要删除这个组吗？")) {
      var url = "/api/Media/DelKeywordCategory?categoryId=" + categoryId + "&user_id=" + $rootScope.userID;
  ...
  $scope.juzhentu = function () {
    var url = "/api/Media/GetRectangularTreeUrl?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
    var q = $http.get(url);
    q.success(function (response, status) {
        if (response.IsSuccess) {
  ...
  $scope.GetD3TreeData = function () {
    var url = "/api/Media/GetAllGroupTreeUrl?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
    var q = $http.get(url);
    q.success(function (response, status) {
      //console.log(response);
  ...
  $scope.GetData = function () {
    var url = "/api/Media/GetKeywordBygroup?user_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
    var q = $http.get(url);
    q.success(function (response, status) {
  ...
  $scope.GetTreeData = function () {
    var url = "/api/Media/GetAllGroupTree?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
    var q = $http.get(url);
    q.success(function (response, status) {
  ...
  $scope.GetECGuanxi = function () {
      if ($scope.WebRelations) {
          var titlelei ='文章关系现状'
          var url = "/api/Media/GetLinkReference?prjId=" + $rootScope.getProjectId + "&timeInterval=" + $scope.GXtimeInterval;
      } else {
          var titlelei = '公众号关系现状'
          var url = "/api/Media/GetNameReference?prjId=" + $rootScope.getProjectId + "&timeInterval=" + $scope.GXtimeInterval;
      }
      var q = $http.get(url);
      q.success(function (response, status) {
          console.log('keywordMng_ctr>GetTreeData');
  ...
  $scope.InsertEntityMapping = function () {
      ...
      $http({
          ...
          url: "/api/Media/InsertEntityMapping"
      })
  ...
  $scope.TextExtractByEntity = function () {
      ...
      $http({
          method: 'get',
          params: $scope.paramsList,
          url: "/api/Media/TextExtractByEntity"
      })
        .success(function (response, status) {
            console.log(response);
  ...
  $scope.GetEntityMapping = function () {
      ...
      $http({
          method: 'get',
          params: $scope.paramsList,
          url: "/api/Media/GetEntityMapping"
      })
        .success(function (response, status) {
            console.log(response);
  ...
  $scope.DelEntityMapping = function (id) {
      ...
      $http({
          method: 'get',
          params: $scope.paramsList,
          url: "/api/Media/DelEntityMapping"
      })
        .success(function (response, status) {
            if (response.IsSuccess) {
                $scope.GetEntityMapping();
  ...
  $scope.ExportKeywordGroup = function () {
    ...
    $http({
      method: 'get',
      params: $scope.paramsList,
      url: "/api/Media/ExportKeywordGroup"
    })
      .success(function (response, status) {
        if (response != null) {
  ...
  $scope.InsertAnalysisItem = function () {
    ...
    var urls = "api/Media/InsertAnalysisItem";
    var q = $http.post(
      urls,
  ...
  $scope.SetPrjAnalysisItem = function (id) {
    ...
    $http({
      ...
      url: "/api/Media/SetPrjAnalysisItem"
    })
      .success(function (response, status) {
        $scope.addAlert('success', response.Message);
  ...
  $scope.GetPrjAnalysisItem = function () {
    ...
    $http({
      method: 'get',
      params: $scope.anaItem,
      url: "/api/Media/GetPrjAnalysisItem"
    })
      .success(function (response, status) {
  ...
  $scope.RemoveAnalysisItem = function (id) {
    if (confirm("您确定要删除本分析指项吗？")) {
      ...
      $http({
        method: 'get',
        params: $scope.anaItem,
        url: "/api/Media/RemoveAnalysisItem"
      })
        .success(function (response, status) {
          $scope.GetAnalysisItem();
          $scope.addAlert('success', response.Message);
  ...
  $scope.InsertEntity = function () {
      ...
      var urls = "api/Media/InsertEntity";
      var q = $http.post(
        urls,
        JSON.stringify($scope.anaItem),
        {
  ...
  $scope.DelEntity=function(id){
      var url = "api/Media/DelEntity?id=" + id;
      var q = $http.get(url);
      q.success(function (response, status) {
          if (response.IsSuccess == true) {
  ...
  $scope.newCategory = function (groupName) {
      if (!groupName) {
          ...
          var urls = "api/Media/SaveDomainCategory";
          var q = $http.post(
              urls,
  ...
  $scope.removeCategory = function (id) {
      if (confirm("您确定要删除该分组吗？")) {
          var url = "api/Media/DelDomainCategory?id=" + id;
          var q = $http.get(url);
          q.success(function (response, status) {
              if (response.IsSuccess) {
  ...
  $scope.newDomain = function () {
      ...
      var urls = "api/Media/SaveDomainCategoryData";
      var q = $http.post(
          urls,
  ...
  $scope.removeChooseDomain = function () {
      ...
      if ($scope.checkedId1 != '') {
          var url = "api/Media/DelDomainCategoryData?DomainId=" + $scope.checkedId1;
          var q = $http.get(url);
          q.success(function (response, status) {
              if (response.IsSuccess) {
  ...
  $scope.GetAllDomainCategoryFrist = function () {
      var url = "api/Media/GetAllDomainCategory?prjId=" + $rootScope.getProjectId;
      var q = $http.get(url);
      q.success(function (response, status) {
          if (response.length == 0) {
              $scope.hasGroup = true;
  ...
  $scope.GetDomainCategoryData = function (id) {
      ...
      var url = "api/Media/GetDomainCategoryData?usrId=" + $rootScope.userID + "&categoryId=" + id + "&page=" + ($scope.pageDomainCategory - 1) + "&pagesize=" + $scope.pagesizeDomainCategory;
      var q = $http.get(url);
      q.success(function (response, status) {
  ...
  $scope.GetDomainCategoryData2 = function () {
    ...
    //获取zTree数据
  $scope.GetTreeData = function () {
      var url = "/api/Media/GetAllFenZhu?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
      var q = $http.get(url);
      q.success(function (response, status) {
  ...
  $scope.D_GetBubbleList = function () {
      ...
      var url = "/api/Media/GetDomainStatis?categoryId=" + $scope.categoryId + "&prjId=" + $rootScope.getProjectId;
      var q = $http.get(url);
      q.success(function (response, status) {
          console.log(response);
  ...
  $scope.InsertReferChartDesc = function () {
      ...
      if (!addAll) {
          ...
          var urls = "/api/Media/InsertReferChartDesc";
          var q = $http.post(
                  urls,
  ...
  $scope.UpdateReferChartDesc = function () {
      ...
      if (!addAll) {
          ...
          var urls = "/api/Media/UpdateReferChartDesc";
          var q = $http.post(
                  urls,
                 JSON.stringify($scope.paramsList),
                 {
  ...
  $scope.GetReferChartDesc = function () {
      var url = "/api/Media/GetReferChartDesc?projectId=" + $rootScope.getProjectId;
      var q = $http.get(url);
      q.success(function (response, status) {
