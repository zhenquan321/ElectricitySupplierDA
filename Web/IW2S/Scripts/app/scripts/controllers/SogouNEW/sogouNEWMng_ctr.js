var sogouNEWMng_ctr = myApp.controller("sogouNEWMng_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, myApplocalStorage) {
    ...
    $scope.kindGroup = function (groupId, InfriLawCode, InfriLawCodeStr, Weight) {
        ...
        var url = "/api/sogou/GetKeywordGroup?usr_id=" + $rootScope.userID + "&groupType=" + $scope.groupType + "&projectId=" + $rootScope.getProjectId;
    ...
    $scope.EditKindGroup = function (groupId, parentid, Name, InfriLawCode, Weight) {
        ...
        var url = "/api/sogou/GetEditKeywordGroup?usr_id=" + $rootScope.userID + "&groupType=" + $scope.groupType + "&projectId=" + $rootScope.getProjectId;
        if ($scope.keywordId != null) {
            url += "&keywordId=" + $scope.keywordId;
        }
        else {
    ...
    $scope.modal_demo = function () {
        ...
        var frm = $modal.open({
            templateUrl: 'Scripts/app/views/modal/addElementGroupSogouNEW.html',
            controller: addElementGroupSogouNEW_ctr,
            scope: kw_scope,
            // label: label,
            keyboard: false,
            backdrop: 'static',
    ...
    $rootScope.GetBaiduSearchKeyword2 = function () {
        var url = "/api/sogou/GetKeywordCategory?user_id=" + $rootScope.userID + "&groupType=" + $scope.groupType + "&projectId=" + $rootScope.getProjectId;
        if ($scope.keywordId != null) {
            url += "&keywordId=" + $scope.keywordId;
        }
        else {
    ...
    $scope.updateCategoryName = function (groupId) {
        ...
        var url = "/api/sogou/UpdateKeywordGroupName?groupid=" + groupId + "&groupName=" + encodeURIComponent(name) + "&user_id=" + $rootScope.userID;
    ...
    $scope.DelCategory = function (categoryId) {
        if (confirm("确定要删除这个组吗？")) {
            var url = "/api/sogou/DelKeywordCategory?categoryId=" + categoryId;
    ...
    $scope.GetTreeData = function () {
        var url = "/api/sogou/GetAllGroupTree?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
        var q = $http.get(url);
        q.success(function (response, status) {
    ...
    $scope.ExportKeywordGroup = function () {
        ...
        $http({
            ...
            url: "/api/sogou/ExportKeywordGroup"
        })
    ...
    $scope.InsertAnalysisItem = function () {
        ...
        var urls = "api/sogou/InsertAnalysisItem";
        var q = $http.post(
            urls,
    ...
    $scope.SetPrjAnalysisItem = function (id) {
        ...
        $http({
            ...
            url: "/api/sogou/SetPrjAnalysisItem"
        })
            .success(function (response, status) {
                $scope.addAlert('success', response.Message);
    ...
    $scope.GetPrjAnalysisItem = function () {
        ...
        $http({
            method: 'get',
            params: $scope.anaItem,
            url: "/api/sogou/GetPrjAnalysisItem"
        })
            .success(function (response, status) {
    ...
    $scope.RemoveAnalysisItem = function (id) {
        if (confirm("您确定要删除本分析指项吗？")) {
            ...
            $http({
                method: 'get',
                params: $scope.anaItem,
                url: "/api/sogou/RemoveAnalysisItem"
            })
                .success(function (response, status) {
                    $scope.GetAnalysisItem();
                    $scope.addAlert('success', response.Message);
