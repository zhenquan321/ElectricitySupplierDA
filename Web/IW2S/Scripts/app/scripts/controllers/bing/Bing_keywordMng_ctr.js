var Bing_keywordMng_ctr = myApp.controller("Bing_keywordMng_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, myApplocalStorage) {
  ...
  $scope.kindGroup = function (groupId, InfriLawCode, InfriLawCodeStr, Weight, ParentName) {
    ...
    var url = "/api/Bing/GetKeywordGroup?usr_id=" + $rootScope.userID + "&groupType=" + $scope.groupType + "&projectId=" + $rootScope.getProjectId;
  ...
  $scope.EditKindGroup = function (groupId, parentid, Name, InfriLawCode, Weight, ParentName) {
    ...
    var url = "/api/Bing/GetEditKeywordGroup?usr_id=" + $rootScope.userID + "&groupType=" + $scope.groupType + "&projectId=" + $rootScope.getProjectId;
    if ($scope.keywordId != null) {
      url += "&keywordId=" + $scope.keywordId;
    }
    else {
  ...
  $scope.searchCategoryAgain = function (id) {
    $scope.isgroup = true;
    var url = "/api/Bing/SetCommendKeywordsStatus?categoryId=" + id + "&prjId=" + $rootScope.getProjectId + "&isgroup=" + $scope.isgroup + "&status=" + 0 + "&user_id=" + $rootScope.userID;
    var q = $http.get(url);
    q.success(function (response, status) {
  ...
  $rootScope.GetBaiduSearchKeyword2 = function () {
    var url = "/api/Bing/GetKeywordCategory?user_id=" + $rootScope.userID + "&groupType=" + $scope.groupType + "&projectId=" + $rootScope.getProjectId;
    if ($scope.keywordId != null) {
      url += "&keywordId=" + $scope.keywordId;
    }
    else {
  ...
  $scope.updateCategoryName = function (groupId) {
    ...
    var url = "/api/Bing/UpdateKeywordGroupName?groupid=" + groupId + "&groupName=" + encodeURIComponent(name) + "&user_id=" + $rootScope.userID;
  ...
  $scope.DelCategory = function (categoryId) {
    if (confirm("确定要删除这个组吗？")) {
      var url = "/api/Bing/DelKeywordCategory?categoryId=" + categoryId + "&user_id=" + $rootScope.userID;
  ...
  $scope.juzhentu = function () {
    var url = "/api/Bing/GetRectangularTreeUrl?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
    var q = $http.get(url);
    q.success(function (response, status) {
  ...
  $scope.GetD3TreeData = function () {
    var url = "/api/Bing/GetAllGroupTreeUrl?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
    var q = $http.get(url);
    q.success(function (response, status) {
      //console.log(response);
  ...
  $scope.GetData = function () {
    var url = "/api/Bing/GetKeywordBygroup?user_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
    var q = $http.get(url);
    q.success(function (response, status) {
  ...
  $scope.GetTreeData = function () {
    var url = "/api/Bing/GetAllGroupTree?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
    var q = $http.get(url);
    q.success(function (response, status) {
  ...
  $scope.ExportKeywordGroup = function () {
    ...
    $http({
      ...
      url: "/api/Bing/ExportKeywordGroup"
    })
  ...
  $scope.InsertAnalysisItem = function () {
    ...
    var urls = "api/Bing/InsertAnalysisItem";
    var q = $http.post(
      urls,
  ...
  $scope.SetPrjAnalysisItem = function (id) {
    ...
    $http({
      ...
      url: "/api/Bing/SetPrjAnalysisItem"
    })
      .success(function (response, status) {
        $scope.addAlert('success', response.Message);
  ...
  $scope.GetPrjAnalysisItem = function () {
    ...
    $http({
      method: 'get',
      params: $scope.anaItem,
      url: "/api/Bing/GetPrjAnalysisItem"
    })
      .success(function (response, status) {
  ...
  $scope.RemoveAnalysisItem = function (id) {
    if (confirm("您确定要删除本分析指项吗？")) {
      ...
      $http({
        method: 'get',
        params: $scope.anaItem,
        url: "/api/Bing/RemoveAnalysisItem"
      })
        .success(function (response, status) {
          $scope.GetAnalysisItem();
          $scope.addAlert('success', response.Message);
