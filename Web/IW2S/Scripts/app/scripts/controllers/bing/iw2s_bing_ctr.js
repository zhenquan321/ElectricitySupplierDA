var iw2s_bing_ctr = myApp.controller("iw2s_bing_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, myApplocalStorage) {


    //selectStatus
    $rootScope.selectStatus = "必应";
    ...
    $scope.keywordsSearch = function () {
        if ($scope.searchInput == "" || $scope.searchInput == null) {
            ...
            var url = "/api/Bing/insertKeyword?user_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId + "&keywords=" + $scope.searchInput;
            var q = $http.get(url);
    ...
    $scope.GetBaiduKeyword = function () {
        ...
        var url = "/api/Bing/GetBaiduKeyword?user_id=" + $rootScope.userID + "&page=" + $scope.pageBaidu + "&projectId=" + $rootScope.getProjectId + "&pagesize=" + $rootScope.pagesizeBaidu;
        var q = $http.get(url);
        q.success(function (response, status) {
    ...
    $scope.GetBaiduLevelLinks = function () {
        var url = "/api/Bing/GetLevelLinks?user_id=" + $rootScope.userID + "&categoryId=" + $rootScope.categoryId + "&projectId=" + $rootScope.getProjectId + "&keywordId=" + $rootScope.BaidukeywordId + "&Title=" + $scope.Title +
    ...
    $scope.SetLinkStatus = function (id, type) {
        ...
        if (type == "delete") {
            if (confirm("确定要删除这条记录吗？")) {
                var url = "/api/Bing/SetLinkStatus?id=" + $scope.id + "&status=" + 2 + "&user_id=" + $rootScope.userID;
                var q = $http.get(url);
                q.success(function (response, status) {
            ...
            if (isStar != true) {
                var url = "/api/Bing/SetLinkStatus?id=" + $scope.id + "&user_id=" + $rootScope.userID + "&status=";
                var q = $http.get(url);
                q.success(function (response, status) {
                    //console.log(response);
                    console.log('iw2s_ctr>SetLinkStatus');
                ...
                var url = "/api/Bing/SetLinkStatus?id=" + $scope.id + "&status=" + 1 + "&user_id=" + $rootScope.userID;
                var q = $http.get(url);
                q.success(function (response, status) {
                    console.log('iw2s_ctr>SetLinkStatus');
                    //console.log(response);
    ...
    $scope.ExcludeKeyword = function (_id) {
        if (confirm("确定要删除这条记录吗？")) {
            ...
            var urls = "api/Bing/ExcludeKeyword";
            var q = $http.post(
                urls,
    ...
    $scope.ExcludeBaiduKeyword = function (_id) {
        if (confirm("确定要删除这条记录吗？")) {
            ...
            var urls = "api/Bing/ExcludeBaiduKeyword";
            var q = $http.post(
                urls,
    ...
    $scope.GetAllKeywordCategory = function () {
        var url = "/api/Bing/GetAllKeywordCategory?user_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
        var q = $http.get(url);
        q.success(function (response, status) {
    ...
    $scope.SetLinkInfriType = function (id, infriType) {
        ...
        $scope.link1ID = id;
        var url = "/api/Bing/SetLinkInfriType?id=" + $scope.link1ID + "&infriType=" + $scope.infriType + "&user_id=" + $rootScope.userID;
        var q = $http.get(url);
        q.success(function (response, status) {
    ...
    $scope.GetProjects = function () {
        ...
        var url = "/api/Bing/GetProjects?usr_id=" + roleId + "&page=" + ($scope.page4 - 1) + "&pagesize=" + $scope.pagesize4;
        var q = $http.get(url);
        q.success(function (response, status) {
