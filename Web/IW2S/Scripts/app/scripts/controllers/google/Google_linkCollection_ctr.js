var Google_linkCollection_ctr = myApp.controller("Google_linkCollection_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, myApplocalStorage) {
