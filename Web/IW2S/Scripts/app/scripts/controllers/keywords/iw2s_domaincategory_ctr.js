var iw2s_domaincategory_ctr = myApp.controller("iw2s_domaincategory_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, $filter, myApplocalStorage) {
