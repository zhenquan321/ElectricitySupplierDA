var iw2s_sogou_ctr = myApp.controller("iw2s_sogou_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, myApplocalStorage) {
    ...
    $scope.keywordsSearch = function () {
        if ($scope.searchInput == "" || $scope.searchInput == null) {
            ...
            var url = "/api/WXSource/insertKeyword?user_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId + "&keywords=" + $scope.searchInput;
            var q = $http.get(url);
            q.success(function (response, status) {
              //  console.log('iw2s_sogou_ctr>keywordsSearch');
    ...
    $scope.GetBaiduKeyword = function () {
        ...
        var url = "/api/WXSource/GetBaiduKeyword?user_id=" + $rootScope.userID + "&page=" + $scope.pageBaidu + "&projectId=" + $rootScope.getProjectId + "&pagesize=" + $rootScope.pagesizeBaidu;
        var q = $http.get(url);
        q.success(function (response, status) {
          //  console.log('iw2s_sogou_ctr>GetBaiduKeyword');
        ...
        q.success(function (response, status) {
          //  console.log('iw2s_sogou_ctr>GetBaiduLeveLinks');
            ...
            if (response != null) {
                ...
                //console.log($rootScope.WXresultList)
    ...
    $scope.SetLinkStatus = function (id, type) {
        ...
        if (type == "delete") {
            if (confirm("确定要删除这条记录吗？")) {
                var url = "/api/WXSource/SetLinkStatus?id=" + $scope.id + "&status=" + 2 + "&user_id=" + $rootScope.userID;
                var q = $http.get(url);
                q.success(function (response, status) {
                  //  console.log('iw2s_sogou_ctr>SetLinkStatus');
            ...
            if (isStar != true) {
                var url = "/api/WXSource/SetLinkStatus?id=" + $scope.id + "&status=" + "&user_id=" + $rootScope.userID;
                var q = $http.get(url);
                q.success(function (response, status) {
                   // console.log('iw2s_sogou_ctr>SetLinkStatus');
                    //console.log(response);
                ...
                var url = "/api/WXSource/SetLinkStatus?id=" + $scope.id + "&status=" + 1 + "&user_id=" + $rootScope.userID;
                var q = $http.get(url);
                q.success(function (response, status) {
                  //  console.log('iw2s_sogou_ctr>SetLinkStatus');
                    //console.log(response);
    ...
    $scope.ExcludeKeyword = function (_id) {
        if (confirm("确定要删除这条记录吗？")) {
            ...
            var urls = "api/WXSource/ExcludeKeyword";
            var q = $http.post(
                urls,
            ...
            q.success(function (response, status) {
               // console.log('iw2s_sogou_ctr>ExcludeKeyword');
    ...
    $scope.ExcludeBaiduKeyword = function (_id) {
        if (confirm("确定要删除这条记录吗？")) {
            ...
            var urls = "api/WXSource/ExcludeBaiduKeyword";
            var q = $http.post(
                urls,
    ...
    $scope.GetAllKeywordCategory = function () {
        var url = "/api/WXSource/GetAllKeywordCategory?user_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
        var q = $http.get(url);
        q.success(function (response, status) {
          //  console.log('iw2s_sogou_ctr>GetAllKeywordCategory');
    ...
    $scope.SetLinkInfriType = function (id, infriType) {
        ...
        $scope.link1ID = id;
        var url = "/api/WXSource/SetLinkInfriType?id=" + $scope.link1ID + "&infriType=" + $scope.infriType + "&user_id=" + $rootScope.userID;
        var q = $http.get(url);
        q.success(function (response, status) {
    ...
    $scope.GetPrjAnalysisItem2 = function () {
        ...
        $http({
            ...
            url: "/api/WXSource/GetPrjAnalysisItem"
        })
