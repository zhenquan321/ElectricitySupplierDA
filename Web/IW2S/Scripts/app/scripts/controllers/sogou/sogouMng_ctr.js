var sogouMng_ctr = myApp.controller("sogouMng_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, myApplocalStorage) {
    ...
    $scope.kindGroup = function (groupId, InfriLawCode, InfriLawCodeStr, Weight) {
        ...
        var url = "/api/WXSource/GetKeywordGroup?usr_id=" + $rootScope.userID + "&groupType=" + $scope.groupType + "&projectId=" + $rootScope.getProjectId;
    ...
    $scope.EditKindGroup = function (groupId, parentid, Name, InfriLawCode, Weight) {
        ...
        var url = "/api/WXSource/GetEditKeywordGroup?usr_id=" + $rootScope.userID + "&groupType=" + $scope.groupType + "&projectId=" + $rootScope.getProjectId;
        if ($scope.keywordId != null) {
            url += "&keywordId=" + $scope.keywordId;
        }
        else {
    ...
    $scope.modal_demo = function () {
        ...
        var frm = $modal.open({
            templateUrl: 'Scripts/app/views/modal/addElementGroupSogou.html',
            controller: addElementGroupSogou_ctr,
            scope: kw_scope,
            // label: label,
            keyboard: false,
            backdrop: 'static',
    ...
    $rootScope.GetBaiduSearchKeyword2 = function () {
        var url = "/api/WXSource/GetKeywordCategory?user_id=" + $rootScope.userID + "&groupType=" + $scope.groupType + "&projectId=" + $rootScope.getProjectId;
        if ($scope.keywordId != null) {
            url += "&keywordId=" + $scope.keywordId;
        }
        else {
    ...
    $scope.updateCategoryName = function (groupId) {
        ...
        var url = "/api/WXSource/UpdateKeywordGroupName?groupid=" + groupId + "&groupName=" + encodeURIComponent(name) + "&user_id=" + $rootScope.userID;
    ...
    $scope.DelCategory = function (categoryId) {
        if (confirm("确定要删除这个组吗？")) {
            var url = "/api/WXSource/DelKeywordCategory?categoryId=" + categoryId;
    ...
    $scope.GetTreeData = function () {
        var url = "/api/WXSource/GetAllGroupTree?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
        var q = $http.get(url);
        q.success(function (response, status) {
    ...
    $scope.ExportKeywordGroup = function () {
        ...
        $http({
            ...
            url: "/api/WXSource/ExportKeywordGroup"
        })
    ...
    $scope.GetAnalysisItem = function () {
        ...
        $http({
            method: 'get',
            params: $scope.paramsList,
            url: "/api/WXSource/GetAnalysisItem"
        })
            .success(function (response, status) {
    ...
    $scope.InsertAnalysisItem = function () {
        ...
        var urls = "api/WXSource/InsertAnalysisItem";
        var q = $http.post(
            urls,
    ...
    $scope.SetPrjAnalysisItem = function (id) {
        ...
        $http({
            ...
            url: "/api/WXSource/SetPrjAnalysisItem"
        })
            .success(function (response, status) {
                $scope.addAlert('success', response.Message);
    ...
    $scope.RemoveAnalysisItem = function (id) {
        if (confirm("您确定要删除本分析指项吗？")) {
            ...
            $http({
                method: 'get',
                params: $scope.anaItem,
                url: "/api/WXSource/RemoveAnalysisItem"
            })
                .success(function (response, status) {
                    $scope.GetAnalysisItem();
                    $scope.addAlert('success', response.Message);
    ...
    //重搜
    $scope.searchSogouAgain = function (id) {
        $scope.isgroup = true;
        var url = "/api/Sogou/SetCommendSogouStatus?categoryId=" + id + "&prjId=" + $rootScope.getProjectId + "&isgroup=" + $scope.isgroup + "&status=" + 0 + "&user_id=" + $rootScope.userID;
        var q = $http.get(url);
        q.success(function (response, status) {
    ...
    //搜所有关键词
    $scope.searchAllSogouAgain = function (id) {
        $scope.isgroup = false;
        var url = "/api/Sogou/SetCommendSogouStatus?categoryId=" + id + "&prjId=" + $rootScope.getProjectId + "&isgroup=" + $scope.isgroup + "&status=" + 0 + "&user_id=" + $rootScope.userID;
        var q = $http.get(url);
        q.success(function (response, status) {
