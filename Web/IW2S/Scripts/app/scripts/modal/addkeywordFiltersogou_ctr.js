var addkeywordFilterSogou_ctr = function ($scope, $modalInstance, $rootScope, $http) {
    ...
    $scope.InsertKeywordFilter = function (commendKeywordId) {
        ...
        if ($scope.filterKeywords == "" || $scope.filterKeywords == null) {
            ...
            var url = "/api/WXSource/InsertKeywordFilter?user_id=" + $rootScope.userID + "&commendKeywordId=" + $rootScope.BaidukeywordId + "&keywords=" + $scope.filterKeywords + "&projectId=" + $rootScope.getProjectId;
            var q = $http.get(url);
    ...
    $scope.GetKeywordFilter = function () {
        var url = "/api/WXSource/GetKeywordFilter?user_id=" + $rootScope.userID + "&keywordId=" + $rootScope.BaidukeywordId + "&projectId=" + $rootScope.getProjectId;
        var q = $http.get(url);
        q.success(function (response, status) {
    ...
    $scope.DelKeywordFilter = function (id) {
        ...
        $scope.filterIds = id;
        var url = "/api/WXSource/DelKeywordFilter?filterIds=" + $scope.filterIds;
        var q = $http.get(url);
        q.success(function (response, status) {
