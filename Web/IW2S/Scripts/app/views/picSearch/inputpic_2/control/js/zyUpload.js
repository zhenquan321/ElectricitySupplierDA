		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
	            	...
	            	html += '					</div>';
	            	html += '				</div>';
	            	html += '	                <input type="text" class="form-control search-content input_pic" id="name9" placeholder="请输入图片链接地址" ng-model="input_pic_address">';
					html += '			<span id="fileDragArea" class="upload_drag_area">或者将图片拖到此空白处</span>';
					html += '			</div>';
				    ...
				    html += '					<a style="height:'+para.itemHeight+';width:'+para.itemWidth+';" title="点击添加文件" id="rapidAddImg" class="add_imgBox">';
