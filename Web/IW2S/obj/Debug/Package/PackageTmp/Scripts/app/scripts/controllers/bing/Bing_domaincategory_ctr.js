var Bing_domaincategory_ctr = myApp.controller("Bing_domaincategory_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, $filter, myApplocalStorage) {
    ...
    $scope.newCategory = function (groupName) {
        if (!groupName) {
            ...
            var urls = "api/Bing/SaveDomainCategory";
            var q = $http.post(
                urls,
    ...
    $scope.removeCategory = function (id) {
        if (confirm("您确定要删除该分组吗？")) {
            var url = "api/Bing/DelDomainCategory?id=" + id;
            var q = $http.get(url);
            q.success(function (response, status) {
                if (response.IsSuccess) {
    ...
    $scope.newDomain = function () {
        ...
        var urls = "api/Bing/SaveDomainCategoryData";
        var q = $http.post(
            urls,
    ...
    $scope.removeChooseDomain = function () {
        ...
        if ($scope.checkedId1 != '') {
            var url = "api/Bing/DelDomainCategoryData?DomainId=" + $scope.checkedId1;
            var q = $http.get(url);
            q.success(function (response, status) {
                if (response.IsSuccess) {
    ...
    $scope.GetDomainCategoryData = function (id) {
        ...
        var url = "api/Bing/GetDomainCategoryData?usrId=" + $rootScope.userID + "&categoryId=" + id + "&page=" + ($scope.pageDomainCategory - 1) + "&pagesize=" + $scope.pagesizeDomainCategory;
        var q = $http.get(url);
        q.success(function (response, status) {
