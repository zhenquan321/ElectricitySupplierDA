var Bing_linkCollection_ctr = myApp.controller("Bing_linkCollection_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, myApplocalStorage) {
