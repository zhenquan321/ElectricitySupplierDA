var Bing_showDesc_ctr = myApp.controller("Bing_showDesc_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, myApplocalStorage) {
    ...
    $scope.keywordsSearch = function () {
        if ($scope.searchInput == "" || $scope.searchInput == null) {
            ...
            var url = "/api/Bing/insertKeyword?user_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId + "&keywords=" + encodeURIComponent($scope.searchInput);
            var q = $http.get(url);
