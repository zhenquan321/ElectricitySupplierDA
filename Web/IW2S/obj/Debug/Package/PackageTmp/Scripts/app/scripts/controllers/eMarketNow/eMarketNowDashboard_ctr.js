var eMarketNowDashboard_ctr = myApp.controller("eMarketNowDashboard_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, $filter, myApplocalStorage) {
    ...
    //    var url = "/api/EMN/GetAllFenZhu?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
    //    var q = $http.get(url);
    ...
    //    var url = "/api/EMN/GetFenleiKeywords?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId + "&treeNodeId=" + treeNode.id;
    //    var q = $http.get(url);
    //    q.success(function (response, status) {
    ...
    //    var url = "/api/EMN/GetFenleiKeywords?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId + "&treeNodeId=" + id;
    //    var q = $http.get(url);
    //    q.success(function (response, status) {
    //        $scope.GetAllKeywordCategory_list = response;
    //    });
    ...
    //        $scope.GetBubbleList(treeNodeId);
    //    }
    //    console.log(treeNodeId);
    //}
    //$scope.GetBubbleList = function (treeNodeId) {
    //    var url = "/api/Dashboard/GetShouyeBubbleList?user_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId + "&kid=" + treeNodeId;
    //    var q = $http.get(url);
    //    q.success(function (response, status) {
    //        console.log(response);
