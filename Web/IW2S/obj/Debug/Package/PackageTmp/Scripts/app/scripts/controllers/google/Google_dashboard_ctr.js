var Google_dashboard_ctr = myApp.controller("Google_dashboard_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, $filter, myApplocalStorage) {
