var Google_keywordMng_ctr = myApp.controller("Google_keywordMng_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, myApplocalStorage) {
  ...
  $scope.kindGroup = function (groupId, InfriLawCode, InfriLawCodeStr, Weight, ParentName) {
    ...
    var url = "/api/Google/GetKeywordGroup?usr_id=" + $rootScope.userID + "&groupType=" + $scope.groupType + "&projectId=" + $rootScope.getProjectId;
  ...
  $scope.EditKindGroup = function (groupId, parentid, Name, InfriLawCode, Weight, ParentName) {
    ...
    var url = "/api/Google/GetEditKeywordGroup?usr_id=" + $rootScope.userID + "&groupType=" + $scope.groupType + "&projectId=" + $rootScope.getProjectId;
    if ($scope.keywordId != null) {
      url += "&keywordId=" + $scope.keywordId;
    }
    else {
  ...
  $scope.searchCategoryAgain = function (id) {
    $scope.isgroup = true;
    var url = "/api/Google/SetCommendKeywordsStatus?categoryId=" + id + "&prjId=" + $rootScope.getProjectId + "&isgroup=" + $scope.isgroup + "&status=" + 0 + "&user_id=" + $rootScope.userID;
    var q = $http.get(url);
    q.success(function (response, status) {
  ...
  $rootScope.GetBaiduSearchKeyword2 = function () {
      var url = "/api/Google/GetKeywordCategory?user_id=" + $rootScope.userID + "&groupType=" + $scope.groupType + "&projectId=" + $rootScope.getProjectId;
    if ($scope.keywordId != null) {
      url += "&keywordId=" + $scope.keywordId;
    }
    else {
  ...
  $scope.updateCategoryName = function (groupId) {
    ...
    var url = "/api/Google/UpdateKeywordGroupName?groupid=" + groupId + "&groupName=" + encodeURIComponent(name) + "&user_id=" + $rootScope.userID;
  ...
  $scope.DelCategory = function (categoryId) {
    if (confirm("确定要删除这个组吗？")) {
        var url = "/api/Google/DelKeywordCategory?categoryId=" + categoryId + "&user_id=" + $rootScope.userID;
  ...
  $scope.juzhentu = function () {
      var url = "/api/Google/GetRectangularTreeUrl?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
    var q = $http.get(url);
    q.success(function (response, status) {
  ...
  $scope.GetD3TreeData = function () {
      var url = "/api/Google/GetAllGroupTreeUrl?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
    var q = $http.get(url);
    q.success(function (response, status) {
      //console.log(response);
  ...
  $scope.GetData = function () {
      var url = "/api/Google/GetKeywordBygroup?user_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
    var q = $http.get(url);
    q.success(function (response, status) {
  ...
  $scope.GetTreeData = function () {
      var url = "/api/Google/GetAllGroupTree?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId;
    var q = $http.get(url);
    q.success(function (response, status) {
  ...
  $scope.ExportKeywordGroup = function () {
    ...
    $http({
      ...
      url: "/api/Google/ExportKeywordGroup"
    })
  ...
  $scope.GetAnalysisItem = function () {
    ...
    $http({
      method: 'get',
      params: $scope.paramsList,
      url: "/api/Google/GetAnalysisItem"
    })
      .success(function (response, status) {
  ...
  $scope.InsertAnalysisItem = function () {
    ...
    var urls = "api/Google/InsertAnalysisItem";
    var q = $http.post(
      urls,
  ...
  $scope.SetPrjAnalysisItem = function (id) {
    ...
    $http({
      ...
      url: "/api/Google/SetPrjAnalysisItem"
    })
      .success(function (response, status) {
        $scope.addAlert('success', response.Message);
  ...
  $scope.RemoveAnalysisItem = function (id) {
    if (confirm("您确定要删除本分析指项吗？")) {
      ...
      $http({
        method: 'get',
        params: $scope.anaItem,
        url: "/api/Google/RemoveAnalysisItem"
      })
        .success(function (response, status) {
          $scope.GetAnalysisItem();
          $scope.addAlert('success', response.Message);
