var Google_keywordViews_ctr = myApp.controller("Google_keywordViews_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, myApplocalStorage) {
