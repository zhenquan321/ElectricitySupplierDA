var weiboViews_ctr = myApp.controller("weiboViews_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal, myApplocalStorage) {
    ...
    $scope.getkeywords = function () {
        ...
        var url = "/api/weibo/GetFenleiKeywordsView?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId + "&categoryId=" + $scope.treeNodeId;
        var q = $http.get(url);
        q.success(function (response, status) {
    ...
    $scope.getkeywords1 = function (treeNodeId) {
        var url = "/api/weibo/GetFenleiKeywordsView?usr_id=" + $rootScope.userID + "&projectId=" + $rootScope.getProjectId + "&categoryId=" + treeNodeId;
        var q = $http.get(url);
        q.success(function (response, status) {
            $scope.GetAllKeywordCategory_list = response;
        });
    ...
    $scope.GetBaiduLevelLinksView = function () {
        ...
        var urls = "api/weibo/GetLevelLinksView";
        var q = $http.post(
            urls,
    ...
    $scope.SetLinkInfriType = function (infriType) {
        if ($scope.ChkId.length == 0) {
            ...
            var url = "/api/weibo/SetLinkInfriType?id=" + $scope.ChkId1 + "&infriType=" + infriType + "&user_id=" + $rootScope.userID;
            var q = $http.get(url);
            q.success(function (response, status) {
    ...
    $scope.ExportLevelLinks = function () {
        ...
        $http({
            ...
            url: "/api/weibo/ExportLevelLinks"
        })
