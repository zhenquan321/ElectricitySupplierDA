var ReportContents_ctr = myApp.controller("ReportContents_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $interval, $filter, $timeout, $anchorScroll, $modal) {
    $scope.changeBig = 1;
    $scope.maodianNum = 1;
    $scope.leftFloat = {};
    $scope.MouseOn = 0;
