var dashboard_ctr = myApp.controller("dashboard_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore) {

    //中国地图
    $scope.chinaMapData = [];
    $scope.chainMap = function () {
        var response = [{
            BadComments: null,
            BotBrand: null,
            BotStatus: null,
            ...
            ,
            Recent30DaysOrderedNum: null
            ,
            Recent30DaysSoldNum: null
            ,
            Reviews: null
            ,
            SalesVolume: "¥19,250,991.60"
            ,
            ShopID: null
            ,
            ShopName: null
            ...
            SiteName: null
            ,
            TotalBotPackages: null
            ,
            TotalComments: null
            ,
            UId: null
            ,
            _id: "4ef98262-55a5-46f4-aef8-2e4e5357f3c1"
            ,
            pic_url: null
            ,
            salesAmount: 19250991.599999994
            ,
            taobaoID: null
            ,
            taskId: null
    ...
    $scope.barYear = function () {
        var myChart = echarts.init(document.getElementById('barYear'));
        option = {
            title: {
                text: 'ECharts 入门示例'
            },
