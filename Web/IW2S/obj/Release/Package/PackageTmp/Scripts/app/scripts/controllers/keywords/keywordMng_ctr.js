var keywordMng_ctr = myApp.controller("keywordMng_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal) {
  ...
  $scope.keywordControlIsActive7 = function () {
      $scope.keywordCisActive1 = false;
      $scope.keywordCisActive2 = false;
      $scope.keywordCisActive3 = false;
      $scope.keywordCisActive4 = false;
      $scope.keywordCisActive5 = false;
      $scope.keywordCisActive6 = false;
      $scope.keywordCisActive7 = true;
      $scope.GetECGuanxi();
  };
    //echart关系图
  $scope.GetECGuanxi = function () {
      $.get('/Scripts/app/data/webkit-dep.txt', function (webkitDep) {
          eval("var ccc = " + webkitDep);
          webkitDep = ccc;
          var myChart = echarts.init(document.getElementById('GetECGuanxi'));
          option = {
              legend: {
              ...
              series: [{
                  ...
                  data: webkitDep.nodes.map(function (node, idx) {
                      node.id = idx;
                      node.symbolSize = Math.random() * 20 + 5;
