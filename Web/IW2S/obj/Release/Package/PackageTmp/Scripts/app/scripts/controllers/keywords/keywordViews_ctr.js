var keywordViews_ctr = myApp.controller("keywordViews_ctr", function ($scope, $rootScope, $http, $location, $window, $cookieStore, $modal) {
    ...
    $scope.SetLinkStatus = function (id, type) {
        ...
        if (type == "delete") {
            ...
            if (isStar != true) {
                var url = "/api/Keyword/SetLinkStatus?id=" + $scope.id + "&status=" + "&user_id=" + $rootScope.userID;
                var q = $http.get(url);
                q.success(function (response, status) {
                    //console.log(response);
                    console.log('iw2s_ctr>SetLinkStatus');
    ...
    $scope.SetLinkInfriType = function (infriType) {
        if ($scope.ChkId.length == 0) {
            ...
            var url = "/api/Keyword/SetLinkInfriType?id=" + $scope.ChkId1 + "&infriType=" + infriType + "&user_id=" + $rootScope.userID;
            var q = $http.get(url);
            q.success(function (response, status) {
