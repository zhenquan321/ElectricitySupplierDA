var addElementGroupEMN_ctr = function ($scope, $modalInstance, $rootScope, $http) {
    ...
    $scope.newGroup = function () {
        ...
        if ($scope.operate == 1) {
            var url = "/api/EMN/InsertKeywordGroup?usr_id=" + $rootScope.userID + "&groupName=" + encodeURIComponent($scope.groupName) + "&lawCode=" + $scope.InfriType + "&weight=" + $scope.weight + "&groupType=" + groupType + "&keywordIds=" + keywordIds + "&projectId=" + $rootScope.getProjectId;
            ...
            var url = "/api/EMN/UpdateKeywordGroup?groupid=" + $scope.parentgroupId + "&user_id=" + $rootScope.userID + "&groupName=" + encodeURIComponent($scope.groupName) + "&lawCode=" + $scope.InfriType + "&weight=" + $scope.weight + "&groupType=" + groupType + "&keywordIds=" + keywordIds;
