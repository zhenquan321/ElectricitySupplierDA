var addElementGroupSogouNEW_ctr = function ($scope, $modalInstance, $rootScope, $http) {
    ...
    $scope.newGroup = function () {
        ...
        if ($scope.operate == 1) {
            var url = "/api/sogou/InsertKeywordGroup?usr_id=" + $rootScope.userID + "&groupName=" + encodeURIComponent($scope.groupName) + "&lawCode=" + $scope.InfriType + "&weight=" + $scope.weight + "&groupType=" + groupType + "&keywordIds=" + keywordIds + "&projectId=" + $rootScope.getProjectId;
            ...
            var url = "/api/sogou/UpdateKeywordGroup?groupid=" + $scope.parentgroupId + "&user_id=" + $rootScope.userID + "&groupName=" + encodeURIComponent($scope.groupName) + "&lawCode=" + $scope.InfriType + "&weight=" + $scope.weight + "&groupType=" + groupType + "&keywordIds=" + keywordIds;
